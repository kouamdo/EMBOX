...
module_path := embox/compat/posix/util/time

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__util__time
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/util/time
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/util/time.o \
		$(OBJ_DIR)/src/compat/posix/util/linux_timer.o

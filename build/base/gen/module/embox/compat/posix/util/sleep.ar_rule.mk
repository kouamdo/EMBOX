...
module_path := embox/compat/posix/util/sleep

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__util__sleep
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/util/sleep
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/util/sleep.o \
		$(OBJ_DIR)/src/compat/posix/util/nanosleep.o

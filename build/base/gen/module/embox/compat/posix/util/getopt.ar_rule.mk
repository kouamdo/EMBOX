...
module_path := embox/compat/posix/util/getopt

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__util__getopt
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/util/getopt
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/posix/util/Util.my
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/util/getopt.o \
		$(OBJ_DIR)/src/compat/posix/util/getopt_long.o

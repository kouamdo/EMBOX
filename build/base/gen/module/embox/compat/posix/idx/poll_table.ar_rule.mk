...
module_path := embox/compat/posix/idx/poll_table

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__idx__poll_table
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/idx/poll_table
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/posix/idx/Idx.my
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/idx/poll_table.o

...
module_path := embox/compat/posix/idx/ppty

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__idx__ppty
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/idx/ppty
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/idx/pipe_pty.o

...
module_path := embox/compat/posix/pthreads

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__pthreads
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/pthreads
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/posix/pthread/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/pthread/pthread.o \
		$(OBJ_DIR)/src/compat/posix/pthread/pthread_cond.o \
		$(OBJ_DIR)/src/compat/posix/pthread/pthread_mutex.o \
		$(OBJ_DIR)/src/compat/posix/pthread/pthread_cancel.o

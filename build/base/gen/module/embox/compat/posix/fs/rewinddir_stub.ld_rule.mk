...
module_path := embox/compat/posix/fs/rewinddir_stub

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__posix__fs__rewinddir_stub
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/posix/fs/rewinddir_stub
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/posix/fs/rewinddir/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/posix/fs/rewinddir/rewinddir_stub.o

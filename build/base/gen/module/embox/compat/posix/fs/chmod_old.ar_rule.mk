...
module_path := embox/compat/posix/fs/chmod_old

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__fs__chmod_old
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/fs/chmod_old
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/posix/fs/chmod/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/fs/chmod/chmod_old.o

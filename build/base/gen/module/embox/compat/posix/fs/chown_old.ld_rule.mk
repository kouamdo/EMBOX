...
module_path := embox/compat/posix/fs/chown_old

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__posix__fs__chown_old
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/posix/fs/chown_old
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/posix/fs/chown/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/posix/fs/chown/chown_old.o

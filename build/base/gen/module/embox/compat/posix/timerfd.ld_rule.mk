...
module_path := embox/compat/posix/timerfd

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__posix__timerfd
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/posix/timerfd
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/posix/sys/timerfd/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/posix/sys/timerfd/timerfd.o

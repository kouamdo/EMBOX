...
module_path := embox/compat/posix/net/getaddrinfo

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__net__getaddrinfo
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/net/getaddrinfo
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/net/getaddrinfo.o

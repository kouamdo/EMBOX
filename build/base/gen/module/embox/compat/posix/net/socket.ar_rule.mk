...
module_path := embox/compat/posix/net/socket

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__net__socket
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/net/socket
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/posix/net/Net.my
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/net/socket.o \
		$(OBJ_DIR)/src/compat/posix/net/socket_index_operation.o

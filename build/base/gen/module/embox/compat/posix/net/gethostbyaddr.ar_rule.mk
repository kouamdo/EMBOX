...
module_path := embox/compat/posix/net/gethostbyaddr

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__net__gethostbyaddr
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/net/gethostbyaddr
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/net/gethostbyaddr.o

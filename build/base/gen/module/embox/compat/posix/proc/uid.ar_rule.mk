...
module_path := embox/compat/posix/proc/uid

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__posix__proc__uid
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/posix/proc/uid
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/posix/proc/uid.o

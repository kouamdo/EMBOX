...
module_path := embox/compat/posix/proc/atexit_stub

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__posix__proc__atexit_stub
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/posix/proc/atexit_stub
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/posix/proc/atexit/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/posix/proc/atexit/atexit_stub.o

...
module_path := embox/compat/posix/no_utmp

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__posix__no_utmp
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/posix/no_utmp
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/posix/utmp/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/posix/utmp/no_utmp.o

...
module_path := embox/compat/atomic/pseudo_atomic

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__compat__atomic__pseudo_atomic
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/compat/atomic/pseudo_atomic
$(OBJ_DIR)/module/$(module_path).o : my_file := src/compat/atomic/pseudo_atomic/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/compat/atomic/pseudo_atomic/pseudo_atomic.o

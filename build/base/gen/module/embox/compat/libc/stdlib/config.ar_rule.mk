...
module_path := embox/compat/libc/stdlib/config

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__stdlib__config
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/stdlib/config
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/stdlib/getpagesize.o \
		$(OBJ_DIR)/src/compat/libc/stdlib/sysconf.o

...
module_path := embox/compat/libc/stdlib/rand

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__stdlib__rand
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/stdlib/rand
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/stdlib/rand.o \
		$(OBJ_DIR)/src/compat/libc/stdlib/random.o \
		$(OBJ_DIR)/src/compat/libc/stdlib/random_r.o

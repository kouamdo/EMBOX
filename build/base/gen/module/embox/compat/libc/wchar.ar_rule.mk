...
module_path := embox/compat/libc/wchar

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__wchar
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/wchar
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/libc/wchar/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/wchar/wcscmp.o \
		$(OBJ_DIR)/src/compat/libc/wchar/wcsncpy.o \
		$(OBJ_DIR)/src/compat/libc/wchar/wcstrtoimax.o \
		$(OBJ_DIR)/src/compat/libc/wchar/wcstrtoumax.o \
		$(OBJ_DIR)/src/compat/libc/wchar/wctype.o

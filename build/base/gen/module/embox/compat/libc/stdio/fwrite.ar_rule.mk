...
module_path := embox/compat/libc/stdio/fwrite

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__stdio__fwrite
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/stdio/fwrite
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/stdio/fwrite.o

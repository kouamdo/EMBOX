...
module_path := embox/compat/libc/int_types

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__int_types
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/int_types
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/libc/inttypes/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/inttypes/imaxmath.o \
		$(OBJ_DIR)/src/compat/libc/inttypes/strtoimax.o \
		$(OBJ_DIR)/src/compat/libc/inttypes/strtoumax.o

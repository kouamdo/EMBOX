...
module_path := embox/compat/libc/assert

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__compat__libc__assert
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/compat/libc/assert
$(OBJ_DIR)/module/$(module_path).a : my_file := src/compat/libc/assert/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/compat/libc/assert/assert.o

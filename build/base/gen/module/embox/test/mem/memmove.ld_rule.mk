...
module_path := embox/test/mem/memmove

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__mem__memmove
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/mem/memmove
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/mem/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/mem/memmove.o

...
module_path := embox/test/stdlib/qsort_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__stdlib__qsort_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/stdlib/qsort_test
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/stdlib/qsort_test.o

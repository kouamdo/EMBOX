...
module_path := embox/test/stdlib/bsearch_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__stdlib__bsearch_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/stdlib/bsearch_test
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/stdlib/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/stdlib/bsearch_test.o

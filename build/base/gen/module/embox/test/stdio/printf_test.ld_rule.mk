...
module_path := embox/test/stdio/printf_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__stdio__printf_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/stdio/printf_test
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/stdio/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/stdio/printf_test.o

...
module_path := embox/test/recursion

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__recursion
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/recursion
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/recursion/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/recursion/stack_recursion.o

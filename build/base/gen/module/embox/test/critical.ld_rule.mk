...
module_path := embox/test/critical

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__critical
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/critical
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/critical/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/critical/critical.o

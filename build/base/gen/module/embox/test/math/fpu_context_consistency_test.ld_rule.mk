...
module_path := embox/test/math/fpu_context_consistency_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__math__fpu_context_consistency_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/math/fpu_context_consistency_test
$(OBJ_DIR)/module/$(module_path).o : my_file := src/tests/math/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/math/fpu_context_consistency_test.o

...
module_path := embox/test/math/math_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__math__math_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/math/math_test
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/math/math_test.o

...
module_path := embox/test/posix/select_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__test__posix__select_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/test/posix/select_test
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/tests/posix/select_test.o

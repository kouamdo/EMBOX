...
module_path := embox/framework/mod_integrity

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__framework__mod_integrity
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/framework/mod_integrity
$(OBJ_DIR)/module/$(module_path).o : my_file := src/framework/mod/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/framework/mod/mod_integrity.o

...
module_path := embox/framework/runlevel

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__framework__runlevel
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/framework/runlevel
$(OBJ_DIR)/module/$(module_path).o : my_file := src/framework/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/framework/runlevel.o \
		$(OBJ_DIR)/src/framework/unit.o

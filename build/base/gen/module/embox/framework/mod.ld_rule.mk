...
module_path := embox/framework/mod

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__framework__mod
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/framework/mod
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/framework/mod/core.o \
		$(OBJ_DIR)/src/framework/mod/depsinject.o

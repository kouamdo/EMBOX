...
module_path := embox/framework/test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__framework__test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/framework/test
$(OBJ_DIR)/module/$(module_path).o : my_file := src/framework/test/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/framework/test/emit.o \
		$(OBJ_DIR)/src/framework/test/registry.o \
		$(OBJ_DIR)/src/framework/test/run.o

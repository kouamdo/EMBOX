...
module_path := embox/fs/syslib/file_system_full

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__syslib__file_system_full
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/syslib/file_system_full
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/syslib/kfsop.o \
		$(OBJ_DIR)/src/fs/syslib/fsop.o

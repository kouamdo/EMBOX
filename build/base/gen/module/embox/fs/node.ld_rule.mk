...
module_path := embox/fs/node

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__node
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/node
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/inode.o \
		$(OBJ_DIR)/src/fs/dentry.o

...
module_path := embox/fs/buffer_cache

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__buffer_cache
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/buffer_cache

...
module_path := embox/fs/xattr

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__xattr
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/xattr

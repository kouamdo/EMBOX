...
module_path := embox/fs/journal

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__journal
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/journal

...
module_path := embox/fs/file_desc

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__file_desc
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/file_desc
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/file_desc.o \
		$(OBJ_DIR)/src/fs/file_xattr.o

...
module_path := embox/fs/core

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__core
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/core

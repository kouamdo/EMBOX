...
module_path := embox/fs/driver/nfs

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__driver__nfs
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/driver/nfs
$(OBJ_DIR)/module/$(module_path).o : my_file := src/fs/driver/nfs/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/driver/nfs/nfs.o \
		$(OBJ_DIR)/src/fs/driver/nfs/xdr_nfs.o

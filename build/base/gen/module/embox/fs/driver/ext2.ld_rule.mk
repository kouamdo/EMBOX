...
module_path := embox/fs/driver/ext2

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__driver__ext2
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/driver/ext2
$(OBJ_DIR)/module/$(module_path).o : my_file := src/fs/driver/ext2/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/driver/ext2/ext2.o \
		$(OBJ_DIR)/src/fs/driver/ext2/ext2_balloc.o

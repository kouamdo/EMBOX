...
module_path := embox/fs/driver/PseudoFs

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__driver__PseudoFs
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/driver/PseudoFs
$(OBJ_DIR)/module/$(module_path).o : my_file := src/fs/driver/pseudofs/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/driver/pseudofs/pseudofs.o

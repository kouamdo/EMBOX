...
module_path := embox/fs/driver/ramfs_old

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__driver__ramfs_old
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/driver/ramfs_old
$(OBJ_DIR)/module/$(module_path).o : my_file := src/fs/driver/ramfs/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/driver/ramfs/ramfs_oldfs.o \
		$(OBJ_DIR)/src/fs/driver/ramfs/ramfs_ops.o

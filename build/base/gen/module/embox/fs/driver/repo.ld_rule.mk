...
module_path := embox/fs/driver/repo

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__fs__driver__repo
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/fs/driver/repo
$(OBJ_DIR)/module/$(module_path).o : my_file := src/fs/driver/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/fs/driver/fs_driver.o

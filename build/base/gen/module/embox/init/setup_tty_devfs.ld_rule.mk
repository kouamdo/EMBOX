...
module_path := embox/init/setup_tty_devfs

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__init__setup_tty_devfs
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/init/setup_tty_devfs
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/init/setup_tty_devfs.o

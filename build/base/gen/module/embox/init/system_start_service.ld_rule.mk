...
module_path := embox/init/system_start_service

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__init__system_start_service
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/init/system_start_service
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/init/system_start_service.o

...
module_path := embox/cmd/exit

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__exit
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/exit

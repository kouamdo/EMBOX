...
module_path := embox/cmd/memmove

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__memmove
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/memmove
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/memmove/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/memmove/memmove.o

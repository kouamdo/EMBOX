...
module_path := embox/cmd/proc/top

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__proc__top
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/proc/top
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/proc/Top.my

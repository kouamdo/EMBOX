...
module_path := embox/cmd/proc/nice

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__proc__nice
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/proc/nice
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/proc/Nice.my

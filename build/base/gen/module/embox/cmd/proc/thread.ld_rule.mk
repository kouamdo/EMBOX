...
module_path := embox/cmd/proc/thread

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__proc__thread
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/proc/thread
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/proc/Thread.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/proc/thread.o

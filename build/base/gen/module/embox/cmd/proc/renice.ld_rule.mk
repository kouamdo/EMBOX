...
module_path := embox/cmd/proc/renice

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__proc__renice
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/proc/renice
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/proc/Renice.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/proc/renice.o

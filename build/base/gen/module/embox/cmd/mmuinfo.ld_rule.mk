...
module_path := embox/cmd/mmuinfo

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__mmuinfo
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/mmuinfo
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/hardware/mmuinfo/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/hardware/mmuinfo/mmuinfo.o

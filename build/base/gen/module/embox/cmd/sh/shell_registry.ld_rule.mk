...
module_path := embox/cmd/sh/shell_registry

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__sh__shell_registry
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/sh/shell_registry
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/shell/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/shell/shell.o

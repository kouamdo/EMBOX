...
module_path := embox/cmd/man

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__man
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/man
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/Man.my

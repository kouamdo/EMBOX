...
module_path := embox/cmd/sys/date

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__sys__date
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/sys/date
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/sys/Date.my

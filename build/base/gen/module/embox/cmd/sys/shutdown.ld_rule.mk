...
module_path := embox/cmd/sys/shutdown

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__sys__shutdown
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/sys/shutdown
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/sys/Shutdown.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/sys/shutdown.o

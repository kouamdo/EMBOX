...
module_path := embox/cmd/sys/export

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__sys__export
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/sys/export
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/sys/Export.my

...
module_path := embox/cmd/mem

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__mem
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/mem
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/hardware/mem/Mem.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/hardware/mem/mem.o

...
module_path := embox/cmd/service

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__service
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/service
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/Service.my

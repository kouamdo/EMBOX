...
module_path := embox/cmd/testing/block_dev_test

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__testing__block_dev_test
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/testing/block_dev_test
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/testing/block_dev/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/testing/block_dev/block_dev_test.o

...
module_path := embox/cmd/testing/ticker

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__testing__ticker
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/testing/ticker
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/testing/ticker/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/testing/ticker/ticker.o

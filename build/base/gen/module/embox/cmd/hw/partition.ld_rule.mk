...
module_path := embox/cmd/hw/partition

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__hw__partition
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/hw/partition
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/hardware/partition/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/hardware/partition/partition.o

...
module_path := embox/cmd/cpuinfo

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__cpuinfo
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/cpuinfo
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/Cpuinfo.my

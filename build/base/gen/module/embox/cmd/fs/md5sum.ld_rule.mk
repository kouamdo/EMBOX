...
module_path := embox/cmd/fs/md5sum

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__fs__md5sum
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/fs/md5sum
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/fs/md5sum/Md5sum.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/fs/md5sum/md5sum.o

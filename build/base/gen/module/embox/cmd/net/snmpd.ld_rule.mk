...
module_path := embox/cmd/net/snmpd

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__snmpd
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/snmpd
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/Snmpd.my

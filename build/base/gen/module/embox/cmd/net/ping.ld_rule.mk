...
module_path := embox/cmd/net/ping

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__ping
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/ping
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/Ping.my

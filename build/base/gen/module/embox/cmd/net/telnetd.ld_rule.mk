...
module_path := embox/cmd/net/telnetd

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__telnetd
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/telnetd
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/telnetd/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/net/telnetd/telnetd.o \
		$(OBJ_DIR)/src/cmds/net/telnetd/telnet_util.o

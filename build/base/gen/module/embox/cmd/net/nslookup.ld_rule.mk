...
module_path := embox/cmd/net/nslookup

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__nslookup
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/nslookup
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/Nslookup.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/net/nslookup.o

...
module_path := embox/cmd/net/httpd_cgi

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__httpd_cgi
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/httpd_cgi
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/net/httpd/httpd_cgi.o

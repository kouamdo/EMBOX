...
module_path := embox/cmd/net/sendmail

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__sendmail
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/sendmail
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/Sendmail.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/net/sendmail.o

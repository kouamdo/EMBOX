...
module_path := embox/cmd/net/netmanager

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__cmd__net__netmanager
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/cmd/net/netmanager
$(OBJ_DIR)/module/$(module_path).o : my_file := src/cmds/net/Netmanager.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/cmds/net/netmanager.o

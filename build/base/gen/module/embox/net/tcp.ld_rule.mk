...
module_path := embox/net/tcp

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__tcp
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/tcp
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/l4/Mybuild

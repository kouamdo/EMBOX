...
module_path := embox/net/sock

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__sock
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/sock
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/sock.o \
		$(OBJ_DIR)/src/net/socket/sock_hash.o \
		$(OBJ_DIR)/src/net/socket/sock_repo.o \
		$(OBJ_DIR)/src/net/socket/sock_factory.o \
		$(OBJ_DIR)/src/net/socket/sock_wait.o

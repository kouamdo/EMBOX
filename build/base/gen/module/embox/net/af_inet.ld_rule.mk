...
module_path := embox/net/af_inet

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__af_inet
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/af_inet
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/socket/af_inet.o

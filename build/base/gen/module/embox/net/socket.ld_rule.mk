...
module_path := embox/net/socket

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__socket
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/socket
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/socket/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/socket/ksocket.o \
		$(OBJ_DIR)/src/net/socket/socket_desc.o

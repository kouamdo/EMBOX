...
module_path := embox/net/udp_sock

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__udp_sock
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/udp_sock
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/socket/udp_sock.o

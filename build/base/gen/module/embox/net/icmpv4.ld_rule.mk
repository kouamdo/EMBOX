...
module_path := embox/net/icmpv4

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__icmpv4
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/icmpv4
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/l3/Mybuild

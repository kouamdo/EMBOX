...
module_path := embox/net/ipv4

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__ipv4
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/ipv4
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/l3/ipv4/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/l3/ipv4/ip_fragment.o \
		$(OBJ_DIR)/src/net/l3/ipv4/ip_input.o \
		$(OBJ_DIR)/src/net/l3/ipv4/ip_options.o \
		$(OBJ_DIR)/src/net/l3/ipv4/ip_output.o \
		$(OBJ_DIR)/src/net/l3/ipv4/ip_header.o

...
module_path := embox/net/skbuff

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__skbuff
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/skbuff
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/skbuff/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/skbuff/skb.o \
		$(OBJ_DIR)/src/net/skbuff/skb_queue.o

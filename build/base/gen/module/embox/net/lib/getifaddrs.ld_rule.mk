...
module_path := embox/net/lib/getifaddrs

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__lib__getifaddrs
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/lib/getifaddrs
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/lib/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/lib/getifaddrs.o

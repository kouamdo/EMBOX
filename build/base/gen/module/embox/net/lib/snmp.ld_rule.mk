...
module_path := embox/net/lib/snmp

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__lib__snmp
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/lib/snmp
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/lib/snmp/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/lib/snmp/snmp.o

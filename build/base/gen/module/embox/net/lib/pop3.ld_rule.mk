...
module_path := embox/net/lib/pop3

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__lib__pop3
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/lib/pop3

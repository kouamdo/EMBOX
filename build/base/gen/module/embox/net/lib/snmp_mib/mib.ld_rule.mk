...
module_path := embox/net/lib/snmp_mib/mib

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__lib__snmp_mib__mib
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/lib/snmp_mib/mib
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/lib/snmp/mib/mib.o

...
module_path := embox/net/lib/snmp_mib/mib_mac

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__lib__snmp_mib__mib_mac
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/lib/snmp_mib/mib_mac
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/lib/snmp/mib/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/lib/snmp/mib/mib_mac.o

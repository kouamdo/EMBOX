...
module_path := embox/net/route

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__route
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/route

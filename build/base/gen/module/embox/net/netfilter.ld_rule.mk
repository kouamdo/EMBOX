...
module_path := embox/net/netfilter

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__netfilter
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/netfilter
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/netfilter/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/netfilter/netfilter.o

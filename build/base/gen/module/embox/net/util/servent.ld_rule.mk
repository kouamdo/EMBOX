...
module_path := embox/net/util/servent

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__util__servent
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/util/servent
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/util/servent.o

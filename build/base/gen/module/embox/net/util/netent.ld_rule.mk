...
module_path := embox/net/util/netent

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__util__netent
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/util/netent

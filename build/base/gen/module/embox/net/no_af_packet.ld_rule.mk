...
module_path := embox/net/no_af_packet

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__no_af_packet
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/no_af_packet
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/net/socket/no_af_packet.o

...
module_path := embox/net/l2/ethernet

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__net__l2__ethernet
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/net/l2/ethernet
$(OBJ_DIR)/module/$(module_path).o : my_file := src/net/l2/Mybuild

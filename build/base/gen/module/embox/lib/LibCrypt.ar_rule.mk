...
module_path := embox/lib/LibCrypt

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__lib__LibCrypt
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/lib/LibCrypt
$(OBJ_DIR)/module/$(module_path).a : my_file := src/lib/crypt/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/lib/crypt/crc32.o \
		$(OBJ_DIR)/src/lib/crypt/crc16.o \
		$(OBJ_DIR)/src/lib/crypt/md5.o \
		$(OBJ_DIR)/src/lib/crypt/b64.o

...
module_path := embox/lib/Tokenizer

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__lib__Tokenizer
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/lib/Tokenizer
$(OBJ_DIR)/module/$(module_path).a : my_file := src/lib/shell/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/lib/shell/tokenizer.o

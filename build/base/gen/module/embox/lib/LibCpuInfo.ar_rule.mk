...
module_path := embox/lib/LibCpuInfo

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__lib__LibCpuInfo
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/lib/LibCpuInfo
$(OBJ_DIR)/module/$(module_path).a : my_file := src/lib/cpu_info/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/lib/cpu_info/cpu_info_funcs.o

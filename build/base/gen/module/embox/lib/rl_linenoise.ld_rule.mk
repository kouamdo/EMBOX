...
module_path := embox/lib/rl_linenoise

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__lib__rl_linenoise
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/lib/rl_linenoise
$(OBJ_DIR)/module/$(module_path).o : my_file := src/lib/readline/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/lib/readline/rl_linenoise.o

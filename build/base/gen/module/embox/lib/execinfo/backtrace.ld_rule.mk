...
module_path := embox/lib/execinfo/backtrace

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__lib__execinfo__backtrace
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/lib/execinfo/backtrace
$(OBJ_DIR)/module/$(module_path).o : my_file := src/lib/execinfo/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/lib/execinfo/backtrace.o

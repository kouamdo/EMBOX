...
module_path := embox/service/http_admin

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__service__http_admin
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/service/http_admin
$(OBJ_DIR)/module/$(module_path).o : my_file := src/service/http_admin/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/service/http_admin/http_admin_backend.o

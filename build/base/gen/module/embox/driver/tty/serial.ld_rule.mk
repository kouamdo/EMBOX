...
module_path := embox/driver/tty/serial

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__tty__serial
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/tty/serial
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/tty/serial/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/tty/serial/ttys_processing.o \
		$(OBJ_DIR)/src/drivers/tty/serial/ttys_term.o \
		$(OBJ_DIR)/src/drivers/tty/serial/ttys.o \
		$(OBJ_DIR)/src/drivers/tty/serial/idesc_serial.o

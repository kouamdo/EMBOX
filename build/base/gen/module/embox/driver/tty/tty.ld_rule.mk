...
module_path := embox/driver/tty/tty

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__tty__tty
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/tty/tty

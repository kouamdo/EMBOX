...
module_path := embox/driver/tty/task_breaking_enable

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__tty__task_breaking_enable
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/tty/task_breaking_enable
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/tty/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/tty/task_break_enable.o

...
module_path := embox/driver/virtio

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__virtio
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/virtio
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/virtio/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/virtio/virtio_ring.o \
		$(OBJ_DIR)/src/drivers/virtio/virtio_queue.o

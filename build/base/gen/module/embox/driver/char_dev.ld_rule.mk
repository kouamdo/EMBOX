...
module_path := embox/driver/char_dev

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__char_dev
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/char_dev
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/char/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/char/char_dev.o

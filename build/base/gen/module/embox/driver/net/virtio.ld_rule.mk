...
module_path := embox/driver/net/virtio

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__net__virtio
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/net/virtio
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/net/virtio_net/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/net/virtio_net/virtio_net.o

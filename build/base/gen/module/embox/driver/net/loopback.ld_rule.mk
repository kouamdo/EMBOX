...
module_path := embox/driver/net/loopback

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__net__loopback
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/net/loopback
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/net/loopback/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/net/loopback/loopback.o

...
module_path := embox/driver/serial/core_tty

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__serial__core_tty
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/serial/core_tty
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/serial/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/serial/uart_dev.o

...
module_path := embox/driver/serial/diag

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__serial__diag
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/serial/diag
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/serial/diag_serial.o

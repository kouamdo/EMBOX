...
module_path := embox/driver/scsi

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__scsi
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/scsi
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/scsi/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/scsi/scsi.o \
		$(OBJ_DIR)/src/drivers/scsi/scsi_disk.o \
		$(OBJ_DIR)/src/drivers/scsi/scsi_disk_create.o

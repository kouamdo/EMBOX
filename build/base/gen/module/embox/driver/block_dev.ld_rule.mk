...
module_path := embox/driver/block_dev

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__block_dev
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/block_dev
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/block_dev/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/block_dev/block_dev_idesc.o \
		$(OBJ_DIR)/src/drivers/block_dev/block_dev.o \
		$(OBJ_DIR)/src/drivers/block_dev/block_dev_namer.o

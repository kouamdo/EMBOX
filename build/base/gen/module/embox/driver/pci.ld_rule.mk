...
module_path := embox/driver/pci

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__pci
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/pci
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/pci/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/pci/pci.o \
		$(OBJ_DIR)/src/drivers/pci/pci_repo.o \
		$(OBJ_DIR)/src/drivers/pci/pci_driver.o

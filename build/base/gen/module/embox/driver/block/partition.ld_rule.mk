...
module_path := embox/driver/block/partition

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__block__partition
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/block/partition
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/block_dev/partition/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/block_dev/partition/partition.o

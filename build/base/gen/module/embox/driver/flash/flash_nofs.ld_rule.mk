...
module_path := embox/driver/flash/flash_nofs

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__flash__flash_nofs
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/flash/flash_nofs
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/flash/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/flash/flash_nofs.o \
		$(OBJ_DIR)/src/drivers/flash/flash.o

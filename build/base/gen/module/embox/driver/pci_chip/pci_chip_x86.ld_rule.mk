...
module_path := embox/driver/pci_chip/pci_chip_x86

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__pci_chip__pci_chip_x86
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/pci_chip/pci_chip_x86
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/pci/pci_chip/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/pci/pci_chip/pci_chip_x86.o

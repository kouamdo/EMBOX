...
module_path := embox/driver/diag

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__diag
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/diag
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/diag/Diag.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/diag/diag.o

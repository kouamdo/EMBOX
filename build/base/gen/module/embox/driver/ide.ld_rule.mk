...
module_path := embox/driver/ide

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__ide
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/ide
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/block_dev/ide/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/block_dev/ide/ide_drive.o \
		$(OBJ_DIR)/src/drivers/block_dev/ide/cdrom.o \
		$(OBJ_DIR)/src/drivers/block_dev/ide/harddisk_pio.o \
		$(OBJ_DIR)/src/drivers/block_dev/ide/harddisk_dma.o

...
module_path := embox/driver/usb/hub

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__usb__hub
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/usb/hub
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/usb/usb_hub.o

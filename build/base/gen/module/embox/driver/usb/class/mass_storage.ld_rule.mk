...
module_path := embox/driver/usb/class/mass_storage

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__usb__class__mass_storage
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/usb/class/mass_storage
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/usb/class/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/usb/class/usb_mass_storage.o

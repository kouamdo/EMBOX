...
module_path := embox/driver/clock/pit

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__clock__pit
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/clock/pit
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/clock/pit/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/clock/pit/pit.o

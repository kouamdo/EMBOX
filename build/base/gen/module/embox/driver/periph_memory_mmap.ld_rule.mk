...
module_path := embox/driver/periph_memory_mmap

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__periph_memory_mmap
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/periph_memory_mmap
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/common/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/common/memory.o

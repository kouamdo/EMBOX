...
module_path := embox/driver/virtual/zero

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__virtual__zero
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/virtual/zero
$(OBJ_DIR)/module/$(module_path).o : my_file := src/drivers/virtual/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/virtual/zero.o

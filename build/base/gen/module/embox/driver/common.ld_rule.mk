...
module_path := embox/driver/common

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__driver__common
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/driver/common
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/drivers/common/device.o

...
module_path := embox/kernel/sched/boot_thread

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__sched__boot_thread
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/sched/boot_thread
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/sched/boot_thread.o

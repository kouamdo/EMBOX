...
module_path := embox/kernel/sched/priority/inherit

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__sched__priority__inherit
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/sched/priority/inherit
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/sched/priority/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/sched/priority/inherit.o

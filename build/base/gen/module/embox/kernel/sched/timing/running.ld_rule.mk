...
module_path := embox/kernel/sched/timing/running

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__sched__timing__running
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/sched/timing/running
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/sched/timing/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/sched/timing/running_time.o

...
module_path := embox/kernel/sched/mutex

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__sched__mutex
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/sched/mutex
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/sched/sync/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/sched/sync/mutex.o \
		$(OBJ_DIR)/src/kernel/sched/sync/mutexattr.o

...
module_path := embox/kernel/sched/sched

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__sched__sched
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/sched/sched
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/sched/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/sched/sched_start.o \
		$(OBJ_DIR)/src/kernel/sched/sched.o \
		$(OBJ_DIR)/src/kernel/sched/sched_signal.o

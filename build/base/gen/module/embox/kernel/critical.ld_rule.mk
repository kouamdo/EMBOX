...
module_path := embox/kernel/critical

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__critical
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/critical
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/Critical.my

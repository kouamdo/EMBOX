...
module_path := embox/kernel/lthread/lthread

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__lthread__lthread
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/lthread/lthread
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/lthread/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/lthread/lthread.o \
		$(OBJ_DIR)/src/kernel/lthread/lthread_sched_wait.o

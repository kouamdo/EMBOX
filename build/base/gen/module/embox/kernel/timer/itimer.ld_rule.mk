...
module_path := embox/kernel/timer/itimer

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__timer__itimer
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/timer/itimer
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/time/timer/itimer.o

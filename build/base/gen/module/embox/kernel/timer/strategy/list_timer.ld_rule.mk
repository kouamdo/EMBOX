...
module_path := embox/kernel/timer/strategy/list_timer

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__timer__strategy__list_timer
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/timer/strategy/list_timer
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/time/timer/strategy/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/time/timer/strategy/list_timer.o

...
module_path := embox/kernel/thread/signal/sigstate

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__thread__signal__sigstate
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/thread/signal/sigstate
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/thread/signal/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/thread/signal/sigstate.o

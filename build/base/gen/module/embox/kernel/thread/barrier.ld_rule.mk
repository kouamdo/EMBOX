...
module_path := embox/kernel/thread/barrier

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__thread__barrier
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/thread/barrier
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/thread/sync/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/thread/sync/barrier.o

...
module_path := embox/kernel/thread/signal_impl

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__thread__signal_impl
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/thread/signal_impl
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/thread/signal.o

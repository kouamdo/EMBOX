...
module_path := embox/kernel/irq

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__irq
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/irq

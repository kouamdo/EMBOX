...
module_path := embox/kernel/irq_stack_no_protection

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__irq_stack_no_protection
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/irq_stack_no_protection
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/Irq.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/irq_stack_no_protection.o

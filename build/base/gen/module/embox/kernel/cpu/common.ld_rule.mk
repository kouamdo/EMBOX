...
module_path := embox/kernel/cpu/common

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__cpu__common
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/cpu/common
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/cpu/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/cpu/common.o

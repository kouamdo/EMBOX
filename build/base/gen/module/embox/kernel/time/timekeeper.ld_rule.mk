...
module_path := embox/kernel/time/timekeeper

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__time__timekeeper
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/time/timekeeper
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/time/timekeeping.o

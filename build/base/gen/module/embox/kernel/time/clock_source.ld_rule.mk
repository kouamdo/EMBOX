...
module_path := embox/kernel/time/clock_source

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__time__clock_source
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/time/clock_source
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/time/Time.my
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/time/clock_source.o

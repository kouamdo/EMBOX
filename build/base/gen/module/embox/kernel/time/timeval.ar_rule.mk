...
module_path := embox/kernel/time/timeval

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__kernel__time__timeval
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/kernel/time/timeval
$(OBJ_DIR)/module/$(module_path).a : my_file := src/kernel/time/Time.my
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/kernel/time/timeval.o

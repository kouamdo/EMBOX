...
module_path := embox/kernel/task/syslib/thread_key_table

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__task__syslib__thread_key_table
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/task/syslib/thread_key_table
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/task/syslib/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/task/syslib/thread_key_table.o

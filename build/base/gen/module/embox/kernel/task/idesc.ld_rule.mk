...
module_path := embox/kernel/task/idesc

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__task__idesc
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/task/idesc
$(OBJ_DIR)/module/$(module_path).o : my_file := src/kernel/task/idesc/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/task/idesc/idesc_table.o \
		$(OBJ_DIR)/src/kernel/task/idesc/index_descriptor.o

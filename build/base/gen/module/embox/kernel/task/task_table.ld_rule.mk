...
module_path := embox/kernel/task/task_table

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__kernel__task__task_table
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/kernel/task/task_table
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/kernel/task/task_table.o

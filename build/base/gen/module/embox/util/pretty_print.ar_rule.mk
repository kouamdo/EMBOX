...
module_path := embox/util/pretty_print

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__util__pretty_print
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/util/pretty_print
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/util/pretty_print.o

...
module_path := embox/util/logging

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__util__logging
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/util/logging

...
module_path := embox/util/hashtable

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__util__hashtable
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/util/hashtable
$(OBJ_DIR)/module/$(module_path).a : my_file := src/util/hashtable/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/util/hashtable/hashtable.o

...
module_path := embox/arch/x86/mmu

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__mmu
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/mmu
$(OBJ_DIR)/module/$(module_path).o : my_file := src/arch/x86/mmu/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/mmu/mmu.o \
		$(OBJ_DIR)/src/arch/x86/mmu/cache.o \
		$(OBJ_DIR)/src/mem/vmem/vmem.o \
		$(OBJ_DIR)/src/mem/vmem/mapper.o \
		$(OBJ_DIR)/src/mem/vmem/vmem_context.o

...
module_path := embox/arch/x86/libarch

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__arch__x86__libarch
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/arch/x86/libarch
$(OBJ_DIR)/module/$(module_path).a : my_file := src/arch/x86/lib/Mybuild
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/arch/x86/lib/setjmp.o \
		$(OBJ_DIR)/src/arch/x86/lib/stack_ptr.o \
		$(OBJ_DIR)/src/arch/x86/lib/ptregs_jmp.o

...
module_path := embox/arch/x86/vfork

$(OBJ_DIR)/module/$(module_path).a : $$(ar_prerequisites)

$(OBJ_DIR)/module/$(module_path).a : module_id := embox__arch__x86__vfork
...
$(OBJ_DIR)/module/$(module_path).a : mod_path := embox/arch/x86/vfork
...
$(OBJ_DIR)/module/$(module_path).a : o_files := \
		$(OBJ_DIR)/src/arch/x86/lib/vfork.o

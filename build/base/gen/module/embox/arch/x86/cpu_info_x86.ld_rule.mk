...
module_path := embox/arch/x86/cpu_info_x86

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__cpu_info_x86
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/cpu_info_x86
$(OBJ_DIR)/module/$(module_path).o : my_file := src/arch/x86/lib/cpu_performance/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/lib/cpu_performance/cpu_info.o \
		$(OBJ_DIR)/src/arch/x86/lib/cpu_performance/cpu_counter.o

...
module_path := embox/arch/x86/kernel/interrupt

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__kernel__interrupt
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/kernel/interrupt
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/kernel/irq_entry.o \
		$(OBJ_DIR)/src/arch/x86/kernel/irq_handler.o \
		$(OBJ_DIR)/src/arch/x86/kernel/ipl.o

...
module_path := embox/arch/x86/kernel/arch

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__kernel__arch
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/kernel/arch
$(OBJ_DIR)/module/$(module_path).o : my_file := src/arch/x86/kernel/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/kernel/arch.o \
		$(OBJ_DIR)/src/arch/x86/kernel/cpu_triple_reset.o \
		$(OBJ_DIR)/src/arch/x86/kernel/gdt.o \
		$(OBJ_DIR)/src/arch/x86/kernel/gdt_flush.o \
		$(OBJ_DIR)/src/arch/x86/kernel/idt.o

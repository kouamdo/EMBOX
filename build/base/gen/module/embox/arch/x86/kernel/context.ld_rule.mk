...
module_path := embox/arch/x86/kernel/context

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__kernel__context
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/kernel/context
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/kernel/context.o \
		$(OBJ_DIR)/src/arch/x86/kernel/context_switch.o

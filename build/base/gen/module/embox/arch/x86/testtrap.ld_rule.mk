...
module_path := embox/arch/x86/testtrap

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__testtrap
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/testtrap
$(OBJ_DIR)/module/$(module_path).o : my_file := src/arch/x86/test/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/test/testtraps_core.o

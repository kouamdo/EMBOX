...
module_path := embox/arch/x86/boot/multiboot

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__arch__x86__boot__multiboot
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/arch/x86/boot/multiboot
$(OBJ_DIR)/module/$(module_path).o : my_file := src/arch/x86/boot/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/arch/x86/boot/boot.o \
		$(OBJ_DIR)/src/arch/x86/boot/multiboot_header.o \
		$(OBJ_DIR)/src/arch/x86/boot/multiboot.o

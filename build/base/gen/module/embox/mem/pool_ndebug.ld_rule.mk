...
module_path := embox/mem/pool_ndebug

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__pool_ndebug
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/pool_ndebug
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/misc/Mybuild

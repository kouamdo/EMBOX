...
module_path := embox/mem/bitmask

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__bitmask
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/bitmask
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/pagealloc/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/mem/pagealloc/bitmask.o

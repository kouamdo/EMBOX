...
module_path := embox/mem/slab

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__slab
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/slab

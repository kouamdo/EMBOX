...
module_path := embox/mem/heap_bm

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__heap_bm
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/heap_bm

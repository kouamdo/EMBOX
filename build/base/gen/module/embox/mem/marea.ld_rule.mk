...
module_path := embox/mem/marea

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__marea
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/marea
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/marea/Mybuild

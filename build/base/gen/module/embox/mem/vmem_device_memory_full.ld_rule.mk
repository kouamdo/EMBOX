...
module_path := embox/mem/vmem_device_memory_full

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__vmem_device_memory_full
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/vmem_device_memory_full
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/vmem/vmem_device_memory/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/mem/vmem/vmem_device_memory/vmem_device_memory.o

...
module_path := embox/mem/phymem

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__phymem
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/phymem
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/Mybuild

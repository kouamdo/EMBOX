...
module_path := embox/mem/heap_afterfree_default

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__heap_afterfree_default
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/heap_afterfree_default
$(OBJ_DIR)/module/$(module_path).o : my_file := src/mem/heap/Mybuild
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/mem/heap/heap_afterfree.o

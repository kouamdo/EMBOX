...
module_path := embox/mem/sysmalloc_task_based

$(OBJ_DIR)/module/$(module_path).o : $$(ld_prerequisites)

$(OBJ_DIR)/module/$(module_path).o : module_id := embox__mem__sysmalloc_task_based
...
$(OBJ_DIR)/module/$(module_path).o : mod_path := embox/mem/sysmalloc_task_based
...
$(OBJ_DIR)/module/$(module_path).o : o_files := \
		$(OBJ_DIR)/src/mem/heap/sysmalloc.o

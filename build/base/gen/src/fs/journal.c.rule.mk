...
mod_path := embox/fs/journal

source_file := src/fs/journal.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/fs/journal
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/fs/journal.h -D__EMBUILD_MOD__=embox__fs__journal

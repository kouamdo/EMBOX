...
mod_path := embox/fs/rootfs

source_file := src/fs/rootfs.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/fs/rootfs
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/fs/rootfs.h -D__EMBUILD_MOD__=embox__fs__rootfs

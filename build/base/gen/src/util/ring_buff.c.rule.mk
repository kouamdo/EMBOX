...
mod_path := embox/util/ring

source_file := src/util/ring_buff.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/util/ring
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/util/ring.h -D__EMBUILD_MOD__=embox__util__ring

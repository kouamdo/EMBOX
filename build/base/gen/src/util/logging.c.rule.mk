...
mod_path := embox/util/logging

source_file := src/util/logging.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/util/logging
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/util/logging.h -D__EMBUILD_MOD__=embox__util__logging

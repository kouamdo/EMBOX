...
mod_path := embox/net/skbuff

source_file := src/net/skbuff/skb_queue.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/net/skbuff
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/net/skbuff.h -D__EMBUILD_MOD__=embox__net__skbuff

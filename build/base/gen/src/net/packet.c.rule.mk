...
mod_path := embox/net/packet

source_file := src/net/packet.c

source_base := $(basename $(source_file))

$(OBJ_DIR)/$(source_base).o : $$(cc_prerequisites)

$(OBJ_DIR)/$(source_base).o : mod_path := embox/net/packet
...
$(OBJ_DIR)/$(source_base).o : flags := -include $(SRCGEN_DIR)/include/config/embox/net/packet.h -D__EMBUILD_MOD__=embox__net__packet
